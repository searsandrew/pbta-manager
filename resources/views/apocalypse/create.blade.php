            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-5">
                <div class="grid grid-cols-4 gap-4">
                    <div class="col-span-4 grid grid-cols-1">
                        ...
                        <x-input name="stats" heading="{{ __('Stats') }}" help="{{ __('Use a comma-seperated list for each stat name') }}" />
                        <div class="grid grid-cols-4 gap-3">
                            <x-input name="luck" heading="{{ __('Luck') }}" />
                            <x-input name="harm" heading="{{ __('Harm') }}" />
                            <x-input name="unstable" heading="{{ __('Unstable') }}" />
                            <x-input name="experience" heading="{{ __('Experience') }}" />
                        </div>
                    </div>
